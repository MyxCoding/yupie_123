		...
		if (!(args.length == 0)) {
			if (plugin.warnedOnce.contains(args[0]) == false) {
				...
				sender.sendMessage(ChatColor.GREEN + args[0] + ChatColor.RESET
					...
					&& plugin.warnedOnce.contains(args[0]) == true) {
				if (args.length != 1) {
					sender.sendMessage(ChatColor.RED
							+ "Usage: /warn <player_name>");
					return true;
				...
				sender.sendMessage(ChatColor.GREEN
					...
					&& plugin.warnedOnce.contains(args[0]) == true
					&& plugin.warnedTwice.contains(args[0]) == true) {
				if (args.length != 1) {
					sender.sendMessage(ChatColor.RED
							+ "Usage: /warn <player_name>");
					return true;
				...
				sender.sendMessage(ChatColor.GREEN
					...
					&& plugin.kickedOnce.contains(args[0]) == true
					&& plugin.warnedOnce.contains(args[0]) == true
					&& plugin.warnedTwice.contains(args[0]) == true) {
				if (args.length != 1) {
					sender.sendMessage(ChatColor.RED
			...
			sender.sendMessage(ChatColor.RED + "Usage: /warn <Player>");
		}
		return true;
	}
}
